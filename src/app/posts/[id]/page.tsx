...
import { deletePostById, getPosts, writePost } from "@/utils/posts";
...
export default function Posts({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const data = await getPosts(Number(params.id), undefined, isDesc);
    ...
    fetchData();
  }, [isDesc, params.id, isWritePostClicked]);
